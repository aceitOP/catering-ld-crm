...
export const personalApi = {
  ...
  listAbsence: (id) => api.get(`/personal/${id}/absence`),
  createAbsence: (id, d) => api.post(`/personal/${id}/absence`, d),
  deleteAbsence: (id, absenceId) => api.delete(`/personal/${id}/absence/${absenceId}`),
...
export const voucherOrdersApi = {
  ...
  shopOffers: () => api.get('/voucher-orders/shop-offers'),
  updateShopOffers: (offers) => api.patch('/voucher-orders/shop-offers', { offers }),
