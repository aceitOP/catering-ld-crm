...
const voucherShopRoutes = require('./routes/voucherShop');
...
app.use('/api/venues',     requireAppModule('venues'), require('./routes/venues'));
...
app.use('/api/ingredients', requireAppModule('pro'), require('./routes/ingredients'));
app.use('/api/recipes', requireAppModule('pro'), require('./routes/recipes'));
app.use('/api/vouchers', requireAppModule('vouchers'), require('./routes/vouchers'));
app.use('/api/pub/voucher-shop', requireAppModule('vouchers'), voucherShopRoutes.publicRouter);
app.use('/api/voucher-orders', requireAppModule('vouchers'), voucherShopRoutes.adminRouter);
